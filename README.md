...
The original author of this work, [fquinto](https://github.com/fquinto), provided an awesome piece of code for creating custom firmwares for both C100x and C300x, and I'd like to clean it up a bit, remove any and all (whenever possible) usage of `sudo` and make it slightly more user-friendly.
...
If you're using a Mac (macOS/OS X)
